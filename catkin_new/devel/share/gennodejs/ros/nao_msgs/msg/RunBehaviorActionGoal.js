...
class RunBehaviorActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RunBehaviorGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += RunBehaviorGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RunBehaviorActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = RunBehaviorGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new RunBehaviorGoal()
    }
...
module.exports = RunBehaviorActionGoal;
