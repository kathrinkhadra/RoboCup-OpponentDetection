...
class JointAnglesWithSpeedActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = JointAnglesWithSpeedFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new JointAnglesWithSpeedActionFeedback(null);
    ...
    data.feedback = JointAnglesWithSpeedFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JointAnglesWithSpeedActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = JointAnglesWithSpeedFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new JointAnglesWithSpeedFeedback()
    }
...
module.exports = JointAnglesWithSpeedActionFeedback;
