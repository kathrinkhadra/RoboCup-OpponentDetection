...
class BlinkActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = BlinkFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BlinkActionFeedback(null);
    ...
    data.feedback = BlinkFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BlinkActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = BlinkFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new BlinkFeedback()
    }
...
module.exports = BlinkActionFeedback;
