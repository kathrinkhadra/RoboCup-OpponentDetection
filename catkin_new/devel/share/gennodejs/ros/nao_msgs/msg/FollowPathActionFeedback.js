...
class FollowPathActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FollowPathFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FollowPathActionFeedback(null);
    ...
    data.feedback = FollowPathFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FollowPathActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = FollowPathFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new FollowPathFeedback()
    }
...
module.exports = FollowPathActionFeedback;
