...
class FollowPathActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FollowPathGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += FollowPathGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FollowPathActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = FollowPathGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new FollowPathGoal()
    }
...
module.exports = FollowPathActionGoal;
