...
class RunBehaviorActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RunBehaviorFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RunBehaviorActionFeedback(null);
    ...
    data.feedback = RunBehaviorFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RunBehaviorActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = RunBehaviorFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new RunBehaviorFeedback()
    }
...
module.exports = RunBehaviorActionFeedback;
