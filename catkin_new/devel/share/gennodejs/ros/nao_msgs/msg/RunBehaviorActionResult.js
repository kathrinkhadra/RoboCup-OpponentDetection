...
class RunBehaviorActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RunBehaviorResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RunBehaviorActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = RunBehaviorResult.Resolve(msg.result)
    }
    else {
      resolved.result = new RunBehaviorResult()
    }
...
module.exports = RunBehaviorActionResult;
