...
class BodyPoseActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new BodyPoseFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = BodyPoseFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BodyPoseActionFeedback(null);
    ...
    data.feedback = BodyPoseFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BodyPoseActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = BodyPoseFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new BodyPoseFeedback()
    }
...
module.exports = BodyPoseActionFeedback;
