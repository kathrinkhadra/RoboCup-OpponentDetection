...
class GetTrueposeRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetTrueposeRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetTrueposeRequest
    let len;
    let data = new GetTrueposeRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetTrueposeRequest(null);
    return resolved;
    }
};
...
class GetTrueposeResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetTrueposeResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetTrueposeResponse
    let len;
    let data = new GetTrueposeResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetTrueposeResponse(null);
...
module.exports = {
  Request: GetTrueposeRequest,
  Response: GetTrueposeResponse,
  md5sum() { return '4f3e0bbe7a24e1f929488cd1970222d3'; },
  datatype() { return 'nao_msgs/GetTruepose'; }
};
