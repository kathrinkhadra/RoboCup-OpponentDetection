...
(cl:defmethod cl:initialize-instance :after ((m <CmdPoseService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CmdPoseService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_msgs-srv:<CmdPoseService-request> is deprecated: use nao_msgs-srv:CmdPoseService-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <CmdPoseService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-srv:pose-val is deprecated.  Use nao_msgs-srv:pose instead.")
  (pose m))
...
(cl:defmethod cl:initialize-instance :after ((m <CmdPoseService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CmdPoseService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_msgs-srv:<CmdPoseService-response> is deprecated: use nao_msgs-srv:CmdPoseService-response instead.")))
