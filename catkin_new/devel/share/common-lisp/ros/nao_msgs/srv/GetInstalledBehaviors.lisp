...
(cl:defmethod cl:initialize-instance :after ((m <GetInstalledBehaviors-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetInstalledBehaviors-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_msgs-srv:<GetInstalledBehaviors-request> is deprecated: use nao_msgs-srv:GetInstalledBehaviors-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetInstalledBehaviors-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetInstalledBehaviors-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_msgs-srv:<GetInstalledBehaviors-response> is deprecated: use nao_msgs-srv:GetInstalledBehaviors-response instead.")))

(cl:ensure-generic-function 'behaviors-val :lambda-list '(m))
(cl:defmethod behaviors-val ((m <GetInstalledBehaviors-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-srv:behaviors-val is deprecated.  Use nao_msgs-srv:behaviors instead.")
  (behaviors m))
