...
(cl:defmethod cl:initialize-instance :after ((m <CmdVelService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CmdVelService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_msgs-srv:<CmdVelService-request> is deprecated: use nao_msgs-srv:CmdVelService-request instead.")))

(cl:ensure-generic-function 'twist-val :lambda-list '(m))
(cl:defmethod twist-val ((m <CmdVelService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-srv:twist-val is deprecated.  Use nao_msgs-srv:twist instead.")
  (twist m))
...
(cl:defmethod cl:initialize-instance :after ((m <CmdVelService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CmdVelService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_msgs-srv:<CmdVelService-response> is deprecated: use nao_msgs-srv:CmdVelService-response instead.")))
