...
(cl:defmethod cl:initialize-instance :after ((m <GetTruepose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetTruepose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_msgs-srv:<GetTruepose-request> is deprecated: use nao_msgs-srv:GetTruepose-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetTruepose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetTruepose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_msgs-srv:<GetTruepose-response> is deprecated: use nao_msgs-srv:GetTruepose-response instead.")))
