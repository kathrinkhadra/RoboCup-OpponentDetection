...
(cl:defmethod cl:initialize-instance :after ((m <JointAnglesWithSpeed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointAnglesWithSpeed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_msgs-msg:<JointAnglesWithSpeed> is deprecated: use nao_msgs-msg:JointAnglesWithSpeed instead.")))
...
(cl:defmethod joint_names-val ((m <JointAnglesWithSpeed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-msg:joint_names-val is deprecated.  Use nao_msgs-msg:joint_names instead.")
  (joint_names m))

(cl:ensure-generic-function 'joint_angles-val :lambda-list '(m))
(cl:defmethod joint_angles-val ((m <JointAnglesWithSpeed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-msg:joint_angles-val is deprecated.  Use nao_msgs-msg:joint_angles instead.")
  (joint_angles m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <JointAnglesWithSpeed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-msg:speed-val is deprecated.  Use nao_msgs-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'relative-val :lambda-list '(m))
(cl:defmethod relative-val ((m <JointAnglesWithSpeed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-msg:relative-val is deprecated.  Use nao_msgs-msg:relative instead.")
  (relative m))
