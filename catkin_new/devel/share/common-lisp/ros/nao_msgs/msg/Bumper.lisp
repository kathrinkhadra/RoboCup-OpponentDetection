...
(cl:defmethod cl:initialize-instance :after ((m <Bumper>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Bumper)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_msgs-msg:<Bumper> is deprecated: use nao_msgs-msg:Bumper instead.")))

(cl:ensure-generic-function 'bumper-val :lambda-list '(m))
(cl:defmethod bumper-val ((m <Bumper>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-msg:bumper-val is deprecated.  Use nao_msgs-msg:bumper instead.")
  (bumper m))
