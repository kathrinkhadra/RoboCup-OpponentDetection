...
(cl:defmethod cl:initialize-instance :after ((m <FadeRGB>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FadeRGB)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_msgs-msg:<FadeRGB> is deprecated: use nao_msgs-msg:FadeRGB instead.")))

(cl:ensure-generic-function 'led_name-val :lambda-list '(m))
(cl:defmethod led_name-val ((m <FadeRGB>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-msg:led_name-val is deprecated.  Use nao_msgs-msg:led_name instead.")
  (led_name m))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <FadeRGB>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-msg:color-val is deprecated.  Use nao_msgs-msg:color instead.")
  (color m))

(cl:ensure-generic-function 'fade_duration-val :lambda-list '(m))
(cl:defmethod fade_duration-val ((m <FadeRGB>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-msg:fade_duration-val is deprecated.  Use nao_msgs-msg:fade_duration instead.")
  (fade_duration m))
