...
(cl:defmethod cl:initialize-instance :after ((m <RunBehaviorGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RunBehaviorGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_msgs-msg:<RunBehaviorGoal> is deprecated: use nao_msgs-msg:RunBehaviorGoal instead.")))

(cl:ensure-generic-function 'behavior-val :lambda-list '(m))
(cl:defmethod behavior-val ((m <RunBehaviorGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-msg:behavior-val is deprecated.  Use nao_msgs-msg:behavior instead.")
  (behavior m))
