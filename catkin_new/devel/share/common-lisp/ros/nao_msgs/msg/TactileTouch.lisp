...
(cl:defmethod cl:initialize-instance :after ((m <TactileTouch>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TactileTouch)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_msgs-msg:<TactileTouch> is deprecated: use nao_msgs-msg:TactileTouch instead.")))

(cl:ensure-generic-function 'button-val :lambda-list '(m))
(cl:defmethod button-val ((m <TactileTouch>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-msg:button-val is deprecated.  Use nao_msgs-msg:button instead.")
  (button m))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <TactileTouch>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-msg:state-val is deprecated.  Use nao_msgs-msg:state instead.")
  (state m))
