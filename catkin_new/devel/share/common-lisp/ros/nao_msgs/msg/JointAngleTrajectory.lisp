...
(cl:defmethod cl:initialize-instance :after ((m <JointAngleTrajectory>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointAngleTrajectory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_msgs-msg:<JointAngleTrajectory> is deprecated: use nao_msgs-msg:JointAngleTrajectory instead.")))
...
(cl:defmethod times-val ((m <JointAngleTrajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-msg:times-val is deprecated.  Use nao_msgs-msg:times instead.")
  (times m))
