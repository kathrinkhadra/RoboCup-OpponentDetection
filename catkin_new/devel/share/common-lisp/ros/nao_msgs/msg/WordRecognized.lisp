...
(cl:defmethod cl:initialize-instance :after ((m <WordRecognized>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WordRecognized)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_msgs-msg:<WordRecognized> is deprecated: use nao_msgs-msg:WordRecognized instead.")))

(cl:ensure-generic-function 'words-val :lambda-list '(m))
(cl:defmethod words-val ((m <WordRecognized>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-msg:words-val is deprecated.  Use nao_msgs-msg:words instead.")
  (words m))

(cl:ensure-generic-function 'confidence_values-val :lambda-list '(m))
(cl:defmethod confidence_values-val ((m <WordRecognized>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_msgs-msg:confidence_values-val is deprecated.  Use nao_msgs-msg:confidence_values instead.")
  (confidence_values m))
