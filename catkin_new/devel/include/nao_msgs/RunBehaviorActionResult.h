// Generated by gencpp from file nao_msgs/RunBehaviorActionResult.msg
// DO NOT EDIT!
...
template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::RunBehaviorActionResult_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::RunBehaviorActionResult_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::RunBehaviorActionResult_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::RunBehaviorActionResult_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::RunBehaviorActionResult_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::RunBehaviorActionResult_<ContainerAllocator> const>
  : TrueType
  { };
