// Generated by gencpp from file nao_msgs/CmdVelServiceResponse.msg
// DO NOT EDIT!


#ifndef NAO_MSGS_MESSAGE_CMDVELSERVICERESPONSE_H
#define NAO_MSGS_MESSAGE_CMDVELSERVICERESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::nao_msgs::CmdVelServiceResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::nao_msgs::CmdVelServiceResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::CmdVelServiceResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::CmdVelServiceResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::CmdVelServiceResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::CmdVelServiceResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::CmdVelServiceResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::CmdVelServiceResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::nao_msgs::CmdVelServiceResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::nao_msgs::CmdVelServiceResponse_<ContainerAllocator>&)
  {}
};
...
#endif // NAO_MSGS_MESSAGE_CMDVELSERVICERESPONSE_H
