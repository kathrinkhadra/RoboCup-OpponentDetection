// Generated by gencpp from file nao_msgs/CmdVelServiceRequest.msg
// DO NOT EDIT!


#ifndef NAO_MSGS_MESSAGE_CMDVELSERVICEREQUEST_H
#define NAO_MSGS_MESSAGE_CMDVELSERVICEREQUEST_H
...
std::ostream& operator<<(std::ostream& s, const ::nao_msgs::CmdVelServiceRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::nao_msgs::CmdVelServiceRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::CmdVelServiceRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::CmdVelServiceRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::CmdVelServiceRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::CmdVelServiceRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::CmdVelServiceRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::CmdVelServiceRequest_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::nao_msgs::CmdVelServiceRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nao_msgs::CmdVelServiceRequest_<ContainerAllocator>& v)
  {
    s << indent << "twist: ";
    s << std::endl;
...
#endif // NAO_MSGS_MESSAGE_CMDVELSERVICEREQUEST_H
