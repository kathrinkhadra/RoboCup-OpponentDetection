// Generated by gencpp from file nao_msgs/JointAnglesWithSpeedFeedback.msg
// DO NOT EDIT!
...
template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::JointAnglesWithSpeedFeedback_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::JointAnglesWithSpeedFeedback_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::JointAnglesWithSpeedFeedback_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::JointAnglesWithSpeedFeedback_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::JointAnglesWithSpeedFeedback_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::JointAnglesWithSpeedFeedback_<ContainerAllocator> const>
  : FalseType
  { };
...
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::nao_msgs::JointAnglesWithSpeedFeedback_<ContainerAllocator>&)
  {}
};
