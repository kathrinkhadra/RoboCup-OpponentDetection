// Generated by gencpp from file nao_msgs/JointTrajectoryResult.msg
// DO NOT EDIT!


#ifndef NAO_MSGS_MESSAGE_JOINTTRAJECTORYRESULT_H
#define NAO_MSGS_MESSAGE_JOINTTRAJECTORYRESULT_H
...
{
ros::message_operations::Printer< ::nao_msgs::JointTrajectoryResult_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::JointTrajectoryResult_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::JointTrajectoryResult_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::JointTrajectoryResult_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::JointTrajectoryResult_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::JointTrajectoryResult_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::JointTrajectoryResult_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::nao_msgs::JointTrajectoryResult_<ContainerAllocator> >
{
  ...
  static const char* value(const ::nao_msgs::JointTrajectoryResult_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1c77b3d9dc137611ULL;
  static const uint64_t static_value2 = 0x510fd16c3b792046ULL;
};

template<class ContainerAllocator>
struct DataType< ::nao_msgs::JointTrajectoryResult_<ContainerAllocator> >
{
  static const char* value()
  {
    return "nao_msgs/JointTrajectoryResult";
  }
...
template<class ContainerAllocator>
struct Definition< ::nao_msgs::JointTrajectoryResult_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::nao_msgs::JointTrajectoryResult_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::nao_msgs::JointTrajectoryResult_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nao_msgs::JointTrajectoryResult_<ContainerAllocator>& v)
  {
...
#endif // NAO_MSGS_MESSAGE_JOINTTRAJECTORYRESULT_H
