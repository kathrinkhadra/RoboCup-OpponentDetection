// Generated by gencpp from file nao_msgs/GetTrueposeResponse.msg
// DO NOT EDIT!


#ifndef NAO_MSGS_MESSAGE_GETTRUEPOSERESPONSE_H
#define NAO_MSGS_MESSAGE_GETTRUEPOSERESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::nao_msgs::GetTrueposeResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::nao_msgs::GetTrueposeResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::GetTrueposeResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::GetTrueposeResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::GetTrueposeResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::GetTrueposeResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::GetTrueposeResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::GetTrueposeResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::nao_msgs::GetTrueposeResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nao_msgs::GetTrueposeResponse_<ContainerAllocator>& v)
  {
    s << indent << "pose: ";
    s << std::endl;
...
#endif // NAO_MSGS_MESSAGE_GETTRUEPOSERESPONSE_H
