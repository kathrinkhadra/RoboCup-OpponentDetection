// Generated by gencpp from file nao_msgs/RunBehaviorAction.msg
// DO NOT EDIT!


#ifndef NAO_MSGS_MESSAGE_RUNBEHAVIORACTION_H
#define NAO_MSGS_MESSAGE_RUNBEHAVIORACTION_H
...
{
ros::message_operations::Printer< ::nao_msgs::RunBehaviorAction_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::RunBehaviorAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::RunBehaviorAction_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::RunBehaviorAction_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::RunBehaviorAction_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::RunBehaviorAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::RunBehaviorAction_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::nao_msgs::RunBehaviorAction_<ContainerAllocator> >
{
  ...
  static const char* value(const ::nao_msgs::RunBehaviorAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa6a26afb8ff0902cULL;
  static const uint64_t static_value2 = 0x5587c8bfbdc46892ULL;
};

template<class ContainerAllocator>
struct DataType< ::nao_msgs::RunBehaviorAction_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::nao_msgs::RunBehaviorAction_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::nao_msgs::RunBehaviorAction_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::nao_msgs::RunBehaviorAction_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nao_msgs::RunBehaviorAction_<ContainerAllocator>& v)
  {
    s << indent << "action_goal: ";
    s << std::endl;
    Printer< ::nao_msgs::RunBehaviorActionGoal_<ContainerAllocator> >::stream(s, indent + "  ", v.action_goal);
    s << indent << "action_result: ";
    s << std::endl;
    Printer< ::nao_msgs::RunBehaviorActionResult_<ContainerAllocator> >::stream(s, indent + "  ", v.action_result);
    s << indent << "action_feedback: ";
    s << std::endl;
    Printer< ::nao_msgs::RunBehaviorActionFeedback_<ContainerAllocator> >::stream(s, indent + "  ", v.action_feedback);
  }
};
...
#endif // NAO_MSGS_MESSAGE_RUNBEHAVIORACTION_H
