// Generated by gencpp from file nao_msgs/GetInstalledBehaviorsRequest.msg
// DO NOT EDIT!


#ifndef NAO_MSGS_MESSAGE_GETINSTALLEDBEHAVIORSREQUEST_H
#define NAO_MSGS_MESSAGE_GETINSTALLEDBEHAVIORSREQUEST_H
...
std::ostream& operator<<(std::ostream& s, const ::nao_msgs::GetInstalledBehaviorsRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::nao_msgs::GetInstalledBehaviorsRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::GetInstalledBehaviorsRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nao_msgs::GetInstalledBehaviorsRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::GetInstalledBehaviorsRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_msgs::GetInstalledBehaviorsRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::GetInstalledBehaviorsRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_msgs::GetInstalledBehaviorsRequest_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::nao_msgs::GetInstalledBehaviorsRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::nao_msgs::GetInstalledBehaviorsRequest_<ContainerAllocator>&)
  {}
};
...
#endif // NAO_MSGS_MESSAGE_GETINSTALLEDBEHAVIORSREQUEST_H
